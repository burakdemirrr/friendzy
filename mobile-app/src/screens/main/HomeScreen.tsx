  ...
  return (
    <StyledSafeAreaView className="flex-1 bg-[#0F172A]">
      <StyledView className="px-6 py-4 border-b border-[#1E293B] flex-row items-center justify-between">
        <StyledText className="text-2xl font-bold text-white" style={{ fontFamily: 'SF Pro Display' }}>
          Friendzy
        </StyledText>
      ...
      >
        {posts.length === 0 ? (
          <StyledView className="flex-1 items-center justify-center py-20">
            ...
            <StyledText className="text-[#94A3B8] text-lg mt-4 font-medium">
              No posts yet
            </StyledText>
          </StyledView>
        ) : (
              ...
              >
                ...
                <StyledView className="bg-[#0F172A] rounded-xl p-4 mb-4">
                  <StyledView className="flex-row items-center mb-2">
                    ...
                    <StyledText className="text-white ml-3 flex-1 font-medium">
                ...
                {/* Description */}
                <StyledText className="text-[#E2E8F0] text-base mb-4 leading-6">
                  {post?.description}
                </StyledText>
                ...
                <StyledView className="flex-row items-center justify-between border-t border-[#334155] pt-4">
                  ...
                  >
                    ...
                    />
                    <StyledText className={`ml-2 font-medium ${post.is_liked ? 'text-[#F43F5E]' : 'text-[#94A3B8]'}`}>
                      {post.likes}
                    </StyledText>
                  </StyledTouchableOpacity>
                  ...
                  >
                    ...
                    <StyledText className="text-[#94A3B8] ml-2 font-medium">
                    ...
                    {post?.comments?.map((comment) => (
                      ...
                      >
                        <StyledView className="flex-row items-center mb-2">
                          ...
                          <StyledText className="text-white font-medium ml-3">
